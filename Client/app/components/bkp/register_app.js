 ...
 var Content = React.createClass({
    render:function(){
        return(
          ...
          <Input name="username" Required="fds" validationError="This is a required field"  />
          <div className="row">
          <div className="col-md-4">
...
var CommentBox = React.createClass({
  render: function() {
    return (
     ...
     <a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="image1.png" className="img-circle" alt="Cinque Terre" width="30" height="30"/> <span className="caret"></span></a>
